...
"""
FastAPI application for the Support Triage Env Environment.
...
try:
    ...
    from .support_triage_env_environment import SupportTriageEnvironment
...
def main(host: str = "0.0.0.0", port: int | None = None) -> None:
    ...
    This function enables running the server without Docker:
        ...
        python -m support_triage_env.server.app
    ...
    multiple workers:
        uvicorn support_triage_env.server.app:app --workers 4
    """
    import argparse
